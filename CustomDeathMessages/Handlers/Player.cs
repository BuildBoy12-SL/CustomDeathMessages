        ...
        public void PlayerDied(SpawningRagdollEventArgs ev)
        {
            ...
            switch (ev.Player.Role.Type)
            {
                ...
                case RoleTypeId.ChaosConscript:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.ChaosConscript, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.ChaosMarauder:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.ChaosMarauder, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.ChaosRepressor:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.ChaosRepressor, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.FacilityGuard:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.FacilityGuard, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.NtfCaptain:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.NtfCaptain, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.NtfPrivate:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.NtfPrivate, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.NtfSergeant:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.NtfSergeant, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    ev.IsAllowed = false;
                    break;
                case RoleTypeId.NtfSpecialist:
                    ...
                    Ragdoll.CreateAndSpawn(roleType: RoleTypeId.NtfSpecialist, ev.Player.Nickname, deathReason: deathReason, position: ev.Position, rotation: ev.Rotation, owner: ev.Player);
                    break;
